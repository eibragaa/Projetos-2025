...
const URL = 'https://www.planalto.gov.br/ccivil_03/leis/l8078compilado.htm';
const OUTPUT = path.join(__dirname, '../src/codigo-consumidor.json');
...
async function main() {
  try {
    console.log('Baixando Código do Consumidor do Planalto...');
