...
const URL = 'https://www.planalto.gov.br/ccivil_03/decreto-lei/del5452compilado.htm';
const OUTPUT = path.join(__dirname, '../src/codigo-trabalhista.json');
...
async function main() {
  try {
    console.log('Baixando CLT do Planalto...');
